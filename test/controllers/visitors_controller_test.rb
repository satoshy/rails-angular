...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { first_name: @visitor.first_name, last_name: @visitor.last_name, reason: @visitor.reason }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { first_name: @visitor.first_name, last_name: @visitor.last_name, reason: @visitor.reason }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
